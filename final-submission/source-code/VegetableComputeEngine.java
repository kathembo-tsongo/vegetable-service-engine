...
public class VegetableComputeEngine extends UnicastRemoteObject implements Compute {
    ...
    // Method to get all vegetables info
    public String getAllVegetablesInfo() {
        StringBuilder sb = new StringBuilder();
        sb.append("=== ALL VEGETABLES IN STORAGE ===\n\n");
        if (vegetablePriceTable.isEmpty()) {
            sb.append("No vegetables in storage.\n");
        } else {
            for (Map.Entry<String, Double> entry : vegetablePriceTable.entrySet()) {
